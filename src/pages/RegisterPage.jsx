      ...
      <div style={styles.container}>
        <div style={styles.sidePanel}>
          <div style={styles.brandBlock}>
            ...
            <div>
              <h2 style={styles.brandTitle}>Cinema Listic</h2>
              <p style={styles.brandText}>Join the club for faster checkout, rewards, and saved seats.</p>
            </div>
          </div>
        ...
        <form onSubmit={handleRegister} style={styles.card}>
          <div style={styles.cardHeader}>
            ...
            <p style={styles.subtitle}>Takes less than a minute.</p>
          </div>
...
const styles = {
  ...
  subtitle: { marginTop: 6, color: "rgba(255,255,255,0.7)" },
